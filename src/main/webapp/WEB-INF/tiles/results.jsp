...
<c:forEach var="result" items="${results}">
	...
	<div class="row person-row">											<%--display row to each user --%>
		<div class="col-md-12">
			<div class="results-photo">
				<a href="${profileLink}"><img src="${profilePhoto}" id="profilePhotoImage"></a>
			</div>
			...
			<div class="results-details">
					<div class="results-name">
						...
						<div class="results-interests">
							<c:forEach var="interests" items="${result.interests}" varStatus="status">
			    					<c:url var="interestLink" value="/search?s=${interests}"/>      <!--searching after same interests  --> 
